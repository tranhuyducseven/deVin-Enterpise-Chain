...
impl organizations::Trait for Runtime {
    type Event = Event;
}

impl pallet_products::Trait for Runtime {
    type Event = Event;
    type CreateRoleOrigin = organizations::EnsureOrg<Runtime>;
}

impl pallet_tracking::Trait for Runtime {
    type Event = Event;
    type CreateRoleOrigin = organizations::EnsureOrg<Runtime>;
}
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        Tracking: pallet_tracking::{Module, Call, Storage, Event<T>},
        Organizations: organizations::{Module, Call, Storage, Event<T>, Config<T>},
